...
INSERT INTO `pages` (`id`, `parent`, `name`, `text`, `template`, `link`, `public_flag`) VALUES
	...
	(3, 0, 'Page API', 'blanks/blank-redactor.php', 4, 'redactor', 0),
