...
INSERT INTO `pages` (`id`, `parent`, `name`, `text`, `template`, `link`, `public_flag`) VALUES
	...
	(3, 0, 'Page API', 'blanks/blank-page-api.php', 4, 'redactor', 0),
	(4, 0, 'User API', 'blanks/blank-user.php', 3, 'user', 1),
	(5, 1, 'NEW', 'blocks/block-newpage.php', 3, 'new-page', 0),
	...
	(27, 1, 'Engine', NULL, 5, 'engine', 1),
	(29, 27, 'Структура', '<h2>blank-*</h2>\n</br>\n<p>модули вызываемые самостоятельно, либо через шаблон template_blank.php</p>\n\n<ul>\n<li>- blank-phpinfo.php - выводит результат функции phpinfo()</li>\n<li>- blank-page-api.php - API построенное на AJAX для редактирования страниц</li>\n</ul>\n\n<h2> block-*</h2>\n</br>\n<p>модули встраиваемые в шаблон сайта в < header>, < main> или < footer>, встраивается между другими такими блоками в любом порядке</p>\n\n<ul>\n<li>- block-promo.php - блок с бендером</li>\n<li>- block-quickmenu.php - три кнопки (быстрый доступ)</li>\n<li>- block-sitemap.php - используется в editor для отображения структуры сайта второго уровня</li>\n<li>- block-yandexmap.php - используется в contacts</li>\n<li>- block-editor.ideas.php</li>\n<li>- block-editor.php</li>\n<li>- block-login_form.php</li>\n<li>- block-main.php</li>\n<li>- block-article.php - редактор и отображение новости в шаблоне template_standart и template_contacts</li>\n<li>- block-news.ideas.php</li>\n<li>- block-news.php</li>\n<li>- block-navbar.php</li>\n</ul>\n\n<h2>template-*</h2>\n</br>\n<p>шаблон, имеет ряд переменных определяющих его</p>\n\n<ul>\n<li>- template_blank.php</li>\n<li>- template_block.php</li>\n<li>- template_contacts.php</li>\n<li>- template_main.php</li>\n<li>- template_standart.php</li>\n</ul>\n\n</br>', 1, 'engine-struct', 1),
	(30, 27, 'Markdown', 'https://xakep.ru/2018/10/12/www-md-page/\n\n<script src=\"https://cdn.rawgit.com/oscarmorrison/md-page/5833d6d1/md-page.js\"></script><noscript>\n\n## Структура\n\n### blank-*\n\nмодули вызываемые самостоятельно, либо через шаблон template_blank.php\n\n- blank-phpinfo.php - выводит результат функции phpinfo()\n- blank-page-api.php - API построенное на AJAX для редактирования страниц\n\n### block-*\n\nмодули встраиваемые в шаблон сайта в <header>, <main> или <footer>, встраивается между другими такими блоками в любом порядке\n\n- block-promo.php - блок с бендером\n- block-quickmenu.php - три кнопки (быстрый доступ)\n- block-sitemap.php - используется в editor для отображения структуры сайта второго уровня\n- block-yandexmap.php - используется в contacts\n- block-editor.ideas.php\n- block-editor.php\n- block-login_form.php\n- block-main.php\n- block-article.php - редактор и отображение новости в шаблоне template_standart и template_contacts\n- block-news.ideas.php\n- block-news.php\n- block-navbar.php\n\n### template-*\n\nшаблон, имеет ряд переменных определяющих его\n\n- template_blank.php\n- template_block.php\n- template_contacts.php\n- template_main.php\n- template_standart.php', 1, 'engineff', 1);
